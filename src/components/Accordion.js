...
const Accordion = ({title, children, className}) => {
  ...
  return (
    <div className={`${styles.accordionWrap} ${className} ${isExpanded ? styles.expanded : styles.closed}`}>
