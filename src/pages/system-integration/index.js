      ...
      <div className={`${styles.systemWrap}`}>
        <section className={`${styles.systemSection}`}>
          <div className={`${styles.leftPadding} ${styles.noPadInXs}`}>
            <p>According to Gartner, data is the most valuable commodity available to organizations, and increasing access to good quality data enables operational improvement, better insight into
              performance, and improved decision making.</p>
            <p>The issue many organizations face is the lack of synchronization between the different systems that produce data, whether for sales, accounting, marketing, production, or distribution.
          ...
          <div className={styles.leftPadding}>
            ...
            <p>Our tailored services for systems integration include configuration, data migration, custom development, training, and ongoing support to ensure our clients are fully utilizing each
