...
export default function Home() {
  ...
  // FadeInUp Sentences on the section 2
  const [fadeInUpStarted, setFadeInUpStarted] = useState(false);
      ...
      <ReactFullPage
        ...
        afterLoad={(origin, destination, direction, trigger) => {
          ...
          if (origin.index === 1) {
            ...
            setFadeInUpStarted(false);
          }
          if (destination.index === 1) {
            setFadeInUpStarted(true);
                ...
                <section className={` ${styles.homeSection}`}
                  ...
                  <div className={`${styles.innerSection} _backInLeft22`}>
                    <div className={`${styles.content} bugScroll`}>
                      ...
                      {
                        (fadeInUpStarted && isMobile) &&
                        <>
                          <FadeInUpSentences
                            wrapClass={` s24_42 fw-300`}
                            sentences={[
                              'Our team <span class="blueText">integrates</span>',
                              '<span class="blueText">systems, connects</span>',
                              '<span class="blueText">front-end to back-end,</span>',
                              '<span class="blueText">and streamlines your</span>',
                              '<span class="blueText">business with</span>',
                              '<span class="blueText">automation</span> to move at',
                              'the pace of your',
                              'customers.'
                            ]}
                          />
...

                      {
                        ...
                        <>
                          <FadeInUpSentences
                            wrapClass={` s24_42 fw-300`}
                            sentences={[
                              'Our team <span class="blueText">integrates systems,</span>',
                              '<span class="blueText">connects front-end to back-end,</span>',
                              '<span class="blueText">and streamlines your business</span>',
                              '<span class="blueText">with automation</span> to move at the ',
                              'pace of your customers. '
                            ]}
                          />
                        </>
                      }
